...
using Notes.Application.CQRS.Note.Commands.CreateNote;
using Notes.Application.CQRS.Note.Commands.DeleteNote;
using Notes.Application.CQRS.Note.Commands.UpdateNote;
using Notes.Application.CQRS.Note.Queries.GetNoteDetails;
...
{
    //[ApiVersionNeutral] // Controller will be called even apiVersion haven't specified
    [ApiVersion("1.0")]
    [ApiVersion("2.0")]
