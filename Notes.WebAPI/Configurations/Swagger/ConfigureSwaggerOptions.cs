...
namespace Notes.WebAPI.Configurations.Swagger
{
                ...
                options.SwaggerDoc(description.GroupName,
                    new OpenApiInfo
                    {
                        ...
                        Contact = new OpenApiContact
                        {
                            Name = "LinkedIn",
                            Email = string.Empty,
                            Url = new Uri("https://www.linkedin.com/in/igor-shevchenko-7a2981190/")
                        },
                        License = new OpenApiLicense
                        {
                            Name = "GitHub",
                            Url = new Uri("https://github.com/igor-shevchenko-pro")
                        }
                    });
